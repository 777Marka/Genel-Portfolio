          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Mevcut Değil</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">+63 930 261 99 04</p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <motion.a 
                  href="https://github.com/FFxMarka2132" 
                  target="_blank" 
                ...
                <motion.a 
                  href="https://instagram.com/777mar_ka" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="p-3 text-gray-700 transition-colors bg-gray-100 rounded-full dark:bg-slate-800 dark:text-gray-300 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400"
                  whileHover={{ y: -5 }}
